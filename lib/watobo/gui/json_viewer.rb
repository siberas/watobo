...
module Watobo #:nodoc: all
  module Gui
    ...
    class JsonViewer < FXVerticalFrame
      SEL_TYPE_GREP = 0
      ...
      def setText(object=nil, prefs={})
        ...
        begin
          jb = JSON.parse(o.body.to_s)
          normalized_text = JSON.pretty_generate jb
        rescue => bang
          normalized_text = "No JSON in body\n\n"
          normalized_text << bang.to_s if $DEBUG
        end
